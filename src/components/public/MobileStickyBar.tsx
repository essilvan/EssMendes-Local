...
import { MessageCircle, Calendar, Phone, MapPin } from "lucide-react";
    ...
    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden border-t border-slate-200/90 bg-white/95 backdrop-blur-lg px-3 py-2 shadow-[0_-4px_20px_rgba(0,0,0,0.08)]">
      <div className="flex items-center gap-1.5 max-w-lg mx-auto">
        ...
        <button
          ...
          className="flex-1 flex items-center justify-center gap-1.5 rounded-xl py-2.5 px-3 text-xs font-black text-white shadow-md active:scale-95 transition hover:opacity-95"
